...
export default function AllEntriesScreen({ entries, onDelete }: Props) {
      ...
      ListHeaderComponent={
        <>
          <View style={globalStyles.header}>
            <Text onLongPress={handleClearAll} style={[globalStyles.title, { marginBottom: 29 }]}>All Vehicles</Text>
            <TouchableOpacity onPress={() => {
              ...
              <Ionicons style={{ marginBottom:25, marginRight:13 }} name={searchVisible ? 'close-outline' : 'search-outline'} size={26} color={colors.primary} />
            </TouchableOpacity>
          </View>
          ...
          {searchVisible && (
            <Text style={{ color: colors.textSecondary, fontSize: 14, marginTop: 13, marginBottom: 13, marginLeft: 10 }}>
